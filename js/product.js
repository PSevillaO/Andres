...
function pintarProducts(arrayPintar) {
    ...
    arrayPintar.forEach((product, index) => {
        ...
        <button class="action-btn btn-danger" title="Borrar Producto" onClick="borrarProducto('${product.id}')">
...
console.log(ID)
    ...
    Swal.fire({
        ...
        text: `Confirma que desea borrar !`,
        icon: "warning",
...
function editarProducto(id) {
    ...
    // console.log(productEdit.dateCard);
    // console.log(formatInputName(productEdit.dateCard))
